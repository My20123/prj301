                                ...
                                <div id="main-nav" class="stellarnav d-flex justify-content-end right">
                                    <ul class="menu-list">
                                        ...
                                        <li class="menu-item has-sub">
                                            <a href="Home_1.jsp" class="item-anchor active d-flex align-item-center" data-effect="Home">Home</a>
                    ...
                    <div class="swiper-slide" style="background-image: url('img/Adidas_SUPERNOVA_1545x500_VN.webp');background-repeat: no-repeat;background-size: cover;background-position: center; ">
                        <div class="banner-content">                           
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="btn-wrap">
                                        <a href="shop.html" class="btn btn-light btn-medium d-flex align-items-center" tabindex="0">Mua ngay <i class="icon icon-arrow-io"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
