        ...
        <section id="billboard" class="overflow-hidden">
            ...
            <div class="swiper main-swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide" style="background-image: url('img/Adidas_SUPERNOVA_1545x500_VN.webp');background-repeat: no-repeat;background-size: cover;background-position: center; ">
                        <div class="banner-content">                           
                            <div class="row">
                                <div class="col-md-10"></div>
                                <div class="col-md-2">
                                    <div class="btn-wrap">
                                        <a href="Home.jsp" class="btn btn-light btn-medium d-flex align-items-center" tabindex="0">Mua ngay <i class="icon icon-arrow-io"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide" style="background-image: url('img/Nike_PEGASUS_41_1545x500_VN.webp');background-repeat: no-repeat;background-size: cover;background-position: center;">
                        <div class="banner-content">
                            <div class="row">
                                <div class="col-md-10"></div>
                                <div class="col-md-2">
                    ...
                    <div class="swiper-slide" style="background-image: url('img/UNDER_ARMOUR_Curry_12_1545x500_V.webp');background-repeat: no-repeat;background-size: cover;background-position: center;">
                        <div class="banner-content">
                            <div class="row">
                                <div class="col-md-10"></div>
                                <div class="col-md-2">
        ...
        <section id="featured-products" class="product-store padding-large">
            <div class="container">
                <div class="section-header d-flex flex-wrap align-items-center justify-content-between">
                    ...
                    <div class="btn-wrap">
                        <a href="home" class="d-flex align-items-center">View all products <i class="icon icon icon-arrow-io"></i></a>
                    </div>            
                </div>
